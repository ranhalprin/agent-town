...
export const SEAT_ACTIVITIES: SeatActivityDef[] = [
  ...
  { emote: "emote:wrench",   bubbles: ["Debugging...", "Writing code~", "Fixing bugs..."],    minDuration: 5000,  maxDuration: 12000 },
  { emote: "emote:wrench",   bubbles: ["Refactoring~", "Almost done!", "One more test..."],   minDuration: 4000,  maxDuration: 8000 },
